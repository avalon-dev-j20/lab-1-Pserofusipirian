...
public class Point<P extends Number> {
    ...
    public double distanceTo(Point point) {
        //x.doubleValue() возвращает значение 1.2300000190734863, при том, что x = 1.23,
        //поэтому приходится конвертировать через строку. Но даже при этом 2.32 - 3.0 с типами Double возвращает -0.6800000000000002 
        //Как с этим бороться и зачем нужен метод doubleValue() c такими особенностями, пока остается для меня загадкой.        
